...
def yinjianhuijiguan(url):
    data=[]
    num_retries=2
    with codecs.open('yjfj.csv','a+','utf-8') as csvfile:
        for i in range(len(url)):
            ...
            if not re.search(ur'个人姓名|个人姓|个人名称',tbody) and re.search(ur'主要负责人|法定代表人',tbody) and r10:
                ...
                try:
                    ...
                    result[name[1]]=''
                try:
                    result[name[3]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                except:
                    result[name[3]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)')[0].text.replace(' ','')
                try:
                    result[name[4]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(4)').text.replace(' ','')
                except:
                    result[name[4]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(4)')[0].text.replace(' ','')
                try:
                    result[name[5]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2)').text.replace(' ','')
                except:
                    result[name[5]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2)')[0].text.replace(' ','')
                try:
                    result[name[6]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(3)').text.replace(' ','')
                except:
                    result[name[6]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(3)')[0].text.replace(' ','')
                for i in range(7,len(name)):
                    try:
                        ...
                        result[name[i]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-2))[0].text.replace('\n','')#替换点文字前面的空格
                ...
                if t1 and re.search(ur'被处罚',t3) and not re.search(ur'名称',tt1):
                    ...
                    if t11:
                        ...
                        try:
                            ...
                            result[name[1]]=''
                        try:
                            result[name[3]]=driver.find_element_by_css_selector('table.MsoNormalTable:nth-child(3) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                        except:
                            result[name[3]]='null'

                        try:
                            result[name[4]]=driver.find_element_by_css_selector('table.MsoNormalTable:nth-child(3) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                        except:
                            result[name[4]]='null'
                        result[name[5]]='null'
                        try:
                            result[name[6]]=driver.find_element_by_css_selector('table.MsoNormalTable:nth-child(3) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                        except:
                            result[name[6]]='null'
                        try:
                            result[name[7]]=driver.find_element_by_css_selector('table.MsoNormalTable:nth-child(3) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2)').text.replace(' ','')
                        except:
                            result[name[7]]='null'

                        for i in range(8,len(name)):
                            try:
                                result[name[i]]=driver.find_element_by_css_selector('table.MsoNormalTable:nth-child(3) > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-5)).text.replace('\n','')
                            except:
                                result[name[i]]='null'
                        try:
                            result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                        ...
                        try:
                            ...
                            try:
                                result[name[3]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(5) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                            except:
                                try:
                                     result[name[3]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(6) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                                except:
                                    try:
                                        result[name[3]]=driver.find_element_by_css_selector('.MsoTableGrid > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)').text.replace(' ','')
                                    except:
                                        result[name[3]]='null'
                        try:
                            result[name[4]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3)').text.replace(' ','')
                        except:
                            try:
                                result[name[4]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(5) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3)').text.replace(' ','')
                            except:
                                try:
                                   result[name[4]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(6) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3)').text.replace(' ','')
                                except:
                                    try:
                                        result[name[4]]=driver.find_element_by_css_selector('.MsoTableGrid > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3)').text.replace(' ','')
                                    except:
                                        result[name[4]]='null'
                        ...
                        try:
                            result[name[6]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3)').text.replace(' ','')
                        except:
                            try:
                                result[name[6]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(5) > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3)').text.replace(' ','')
                            except:
                                try:
                                   result[name[6]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(6) > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3)').text.replace(' ','')
                                except:
                                    try:
                                        result[name[6]]=driver.find_element_by_css_selector('.MsoTableGrid > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3)').text.replace(' ','')
                                    except:
                                        result[name[6]]='null'
                        for i in range(7,len(name)):
                            try:
                                result[name[i]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-3)).text.replace('\n','')
                            except:
                                try:
                                    result[name[i]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(5) > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-3)).text.replace('\n','')
                                except:
                                    try:
                                        result[name[i]]=driver.find_element_by_css_selector('.Section0 > table:nth-child(6) > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-3)).text.replace('\n','')
                                    except:
                                        try:
                                            result[name[i]]=driver.find_element_by_css_selector('.MsoTableGrid > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-3)).text.replace('\n','')
                                        except:
                                            result[name[i]]='null'
                        try:
                            result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                    ...
                    try:
                        result[name[6]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2)')[0].text.replace(' ','')
                    except:
                        result[name[6]]='null'
                    try:
                        result[name[7]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(3)')[0].text.replace(' ','')
                    except:
                        result[name[7]]='null'
                    for i in range(8,len(name)):
                        try:
                    ...
                    try:
                        ...
                        result[name[1]]=''
                    try:
                        result[name[3]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2)').text.replace(' ','')
                    except:
                        result[name[3]]='null'
                    try:
                        result[name[4]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(3)').text.replace(' ','')
                    except:
                        result[name[4]]='null'
                    result[name[5]]='null'
                    try:
                        result[name[6]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(5) > td:nth-child(3)')[0].text.replace(' ','')
                    except:
                        result[name[6]]='null'

                    for i in range(7,len(name)):
                        try:
                            result[name[i]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-1)).text.replace('\n','')
                        except:
                            result[name[i]]='null'
                    try:
                        result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                    ...
                    try:
                        ...
                        for i in range(9,len(name)):
                            try:
                                result[name[i]]=driver.find_element_by_css_selector('table.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-5)).text.replace('\n','')
                            except:
                                result[name[i]]='null'
                        result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                        result[name[12]]=timesf(result[name[12]])
                        ...
                        for i in range(7,len(name)):
                            try:
                                result[name[i]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%i)[0].text.replace('\n','')
                            except:
                                result[name[i]]='null'
                        try:
                            result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                    ...
                    for i in range(7,len(name)):
                        try:
                            result[name[i]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i+4)).text.replace('\n','')
                        except:
                            result[name[i]]='null'
                    try:
                        result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                ...
                for i in range(8,len(name)):
                    try:
                        result[name[i]]=driver.find_element_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-5)).text.replace('\n','')
                    except:
                        result[name[i]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-5))[0].text.replace('\n','')
                try:
                    result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                except:
                    result[name[0]]=u'行政处罚信息公开表'
                ...
                if  t and re.search(ur'名称',t):
                    ...
                    for i in range(7,len(name)):
                        try:
                            ...
                            result[name[i]]=driver.find_elements_by_css_selector('.MsoNormalTable > tbody:nth-child(1) > tr:nth-child(%d) > td:nth-child(2)'%(i-4))[0].text.replace('\n','')
                    try:
                        result[name[0]]=result[name[11]]+u'行政处罚信息公开表'
                    except:
                        result[name[0]]=u'行政处罚信息公开表'
    ...
    pd.to_excel('yinjianju-yjj150_200.xlsx')
    return data
